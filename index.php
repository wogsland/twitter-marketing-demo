...
if (isset($_POST['submit'])) {
	...
	while ($num_tweets > 0){
		...
		if (strlen($twitter_status) > 0) {
			$curTwitter = new twitter($_POST['Username'], $_POST['Password']);
...
<body>
	<h2>Twitter Marketing Demo</h2>

<p><strong>Enter Values:</strong></p>
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            Username<br>
		<input name="Username" type="text" id="Username" size="40" maxlength="40" /><p>
            Password<br>
		<input name="Password" type="password" id="Password" size="40" maxlength="40" /><p>
            Search Term<br>
...
<p>
See the 
<a href="http://twitter.com/<?php echo $_POST['Username']; ?>" target=BS>profile output</a>.
</p>
<div id="twitter_div">
...
<script type="text/javascript" src="http://twitter.com/statuses/user_timeline/<?php echo $_POST['Username']; ?>.json?callback=twitterCallback2&amp;count=10"></script>
<p><br>
<p><br>
<p><br>
<p><br>
...
<H5>
<P>
Last Modified: 9 April 2009 by <a href="mailto: bradley@wogsland.org"> Bradley James Wogsland</a>.<br>
